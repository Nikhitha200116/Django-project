...
from .models import Dept, Class, Student,  Course, Teacher, Assign, AssignTime,StudentCourse, Marks, MarksClass, User
...
class StudentAdmin(admin.ModelAdmin):
    list_display = ('Rollno', 'name', 'class_id')
    search_fields = ('Rollno', 'name', 'class_id__id', 'class_id__dept__name')
    ordering = ['class_id__dept__name', 'class_id__id', 'Rollno']
